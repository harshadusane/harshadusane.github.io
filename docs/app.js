...
const FILES_PER_STUDY = 500; // Average files per study/case
const BASE_COST_PER_FILE_PER_YEAR_RELIABLE = 0.10; // Example cost in $
            ...
            ${studiesPerMonth > 0 && selectedDuration > 0 ? html`
                <div class="bg-white p-6 rounded-lg shadow max-w-2xl mx-auto">
                    ...
                    <div class="space-y-3 text-gray-700">
                        ...
                        <p><strong>Estimated In-House Archival Cost:</strong> $${totalInHouseCost.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</p>
                        <div class="pt-3 mt-3 border-t border-gray-200">
                            <p class="text-xl font-bold text-green-600 text-center md:text-left">
                                Potential Savings with Reliable Archival:
                                <span class="block text-2xl mt-1 md:mt-0 md:ml-2">$${savings.toLocaleString(undefined, { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</span>
                            </p>
                        </div>
                    </div>
                </div>
